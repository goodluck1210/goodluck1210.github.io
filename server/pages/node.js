...
module.exports = __webpack_require__("5xxa");
...
module.exports = JSON.parse("{\"title\":\"Benefits of Node.js\",\"list\":[{\"title\":\"Robust JavaScript technology \",\"description\":\"By using Node.js as the backend framework, you automatically get all the benefits of full-featured JavaScript development, including: <ul> <li>optimal application speed;</li> <li>he ability to share and reuse;</li> <li>a huge number of free tools;</li> <li>cross-platform.</li></ul> All this allows us to make the development process as flexible and less time-consuming as possible. As a result, you get high-quality and reliable software in the shortest possible time. JavaScript developers can start programming the back end with minimal effort by packaging existing code into modules and creating new levels of abstraction\",\"img\":\"/images/technologies/node/benefits/img1.png\"},{\"title\":\"Fast request processing and efficient event-driven model\",\"description\":\"Node.js is fast thanks to its V8 engine. Another important advantage is the asynchronous processing of requests. In the context of the server-side, synchronous processing assumes that the code is executed sequentially. The third aspect is the event model. When using the same language on both the client and the backend, synchronization is as fast as possible, which is especially useful for event-driven real-time applications. Due to its asynchronous, single-threaded nature, Node.js is ideal for online games, chat rooms, video conferencing, or any other project that requires constant data updates\",\"img\":\"/images/technologies/node/benefits/img2.png\"},{\"title\":\"Ideal choice for microservices architecture \",\"description\":\"As a simple and lightweight programming environment, Node.js has become an ideal solution for the so-called microservice architecture. This approach involves developing a single application as a collection of small services, each of which operates with its own processes and interacts with lightweight mechanisms, often the HTTP resource API. Since each microservice communicates directly with the database, this architecture can improve the performance and speed of the application\",\"img\":\"/images/technologies/node/benefits/img3.png\"},{\"title\":\"Rich ecosystem\",\"description\":\"NPM - the default Node.js package manager - also serves as the primary platform for open-source JavaScript tools that have played an important role in the development of this programming language. With about a million libraries currently available in the npm registry and over 10,000 new ones being published weekly, the Node.js ecosystem is quite rich. With such a huge variety of free tools available in a few clicks, there is a huge potential for using Node.js. At the same time, open-source software is gaining popularity as it allows new solutions to be created, reducing overall development costs and time-to-market\",\"img\":\"/images/technologies/node/benefits/img4.png\"},{\"title\":\"Full JSON support\",\"description\":\"Node.js uses JSON for communication, without conversion between binary models via JavaScript. This is especially useful when you need to create a RESTful API to support a NoSQL database. This seamless connection to one of the major data transfer standards is another advantage of the JavaScript ecosystem\",\"img\":\"/images/technologies/node/benefits/img5.png\"}]}");
...
// EXTERNAL MODULE: ./components/Technologies/Node/Benefits/Benefits.module.scss
var Benefits_module = __webpack_require__("zIIY");
var Benefits_module_default = /*#__PURE__*/__webpack_require__.n(Benefits_module);

// EXTERNAL MODULE: external "react/jsx-runtime"
var jsx_runtime_ = __webpack_require__("F5FC");

// CONCATENATED MODULE: ./components/Technologies/Node/Benefits/Benefits.js
...
const BenefitsMobTabl = ({
  ...
  const images = ['/images/technologies/node/benefits/img1.png', '/images/technologies/node/benefits/img2.png', '/images/technologies/node/benefits/img3.png', '/images/technologies/node/benefits/img4.png', '/images/technologies/node/benefits/img5.png'];
...
const Benefits = ({
  ...
  const images1 = ['/images/technologies/node/benefits/img1.png', '/images/technologies/node/benefits/img2.png'];
  const images2 = ['/images/technologies/node/benefits/img3.png', '/images/technologies/node/benefits/img4.png', '/images/technologies/node/benefits/img5.png'];
  let images = slide === 2 ? images2 : images1;
  let newList = slide === 2 ? list.slice(2) : list.slice(0, 2);
  return /*#__PURE__*/Object(jsx_runtime_["jsxs"])("div", {
    className: Benefits_module_default.a.wrapper,
    style: {
...
// EXTERNAL MODULE: ./assets/data/node/benefits.json
var benefits = __webpack_require__("52QM");

// EXTERNAL MODULE: ./assets/data/node/reviews.json
var reviews = __webpack_require__("2Kyy");

// EXTERNAL MODULE: ./assets/data/node/faq.json
var faq = __webpack_require__("jSDg");

// EXTERNAL MODULE: ./components/Technologies/Node/index.module.scss
var index_module = __webpack_require__("Nmry");
var index_module_default = /*#__PURE__*/__webpack_require__.n(index_module);

// CONCATENATED MODULE: ./pages/node/index.js
...
function Index({
  ...
  const headerImages = {
    mb: '/images/technologies/node/header/bgMob.jpg',
    tabl: '/images/technologies/node/header/bgTabl.png',
    desk: '/images/technologies/node/header/bgDesk.jpg'
  };
  return /*#__PURE__*/Object(jsx_runtime_["jsx"])(jsx_runtime_["Fragment"], {
    children: /*#__PURE__*/Object(jsx_runtime_["jsxs"])(Scroll["a" /* default */], {
      titles: ['Node JS Consulting by WTT Solutions', 'Benefits of Node.js', 'Benefits of Node.js', 'WE COVER A WIDE MARKETING TECHNOLOGY DEVELOPMENT STACK', 'Knowledge Pillars', 'HERE’S HOW YOU CAN GET IN TOUCH', 'Questions you may have'],
      children: [/*#__PURE__*/Object(jsx_runtime_["jsxs"])(head_default.a, {
        children: [/*#__PURE__*/Object(jsx_runtime_["jsx"])("title", {
          children: metadata["a" /* meta */].nodeTitle
        }), /*#__PURE__*/Object(jsx_runtime_["jsx"])("meta", {
          name: "description",
          content: metadata["a" /* meta */].nodeDescription
        })]
        ...
        children: /*#__PURE__*/Object(jsx_runtime_["jsx"])(CasesPriview["a" /* default */], {
          caseId: 'knowledge-pillars',
          greenTitle: en["a" /* en */].pillarsGreenTitle,
...
/* harmony default export */ var node = __webpack_exports__["default"] = (Index);
...
module.exports = JSON.parse("[{\"question\":\"How many projects does your Node JS  dedicated team have releases? Can you name real product names?\",\"answer\":\"Our Node.js development team has released projects in different industries: Martech, Edtech, HRTech, Healthcare, Financial Services. Some examples of our development team's NodeJS use are projects GMB Crush, Content IQ, Ouzo Games, eSimplify etc. You can read more about them on the page 'Our work'\"},{\"question\":\"Can I hire a dedicated Node JS software development team for my project?\",\"answer\":\"First of all, you will have a Node JS consultation with our project manager to get to know the end-user, clarify project vision, goals & scope, and identify risks. Our solutions are made to make your business work better. After discussion, our angular development team proceeds to the execution of the project.\"},{\"question\":\"Can you provide accurate references to where your Node JS development company was involved?\",\"answer\":\"These are some of the projects involved by our Node JS development team:<ul><li><a href=https://www.contentiq.com >https://www.contentiq.com</a></li><li><a href=https://www.gmbcrush.com>https://www.gmbcrush.com</a></li><li><a href=https://esimplifysolutions.com >https://esimplifysolutions.com</a></li><li><a href=https://knowledge-pillars.com>https://knowledge-pillars.com</a></li></ul>If you are interested in finished projects from a specific industry - leave a request and we will share our experience useful for your project\"},{\"question\":\"Where is your Node JS development company located?\",\"answer\":\"We are located in Ukraine, Kyiv. You can get any advice on your project, implementation tools, and Node JS development services online by filling out the feedback form.\"}]");
...
// Exports
module.exports = {
	"wrapper": "Benefits_wrapper__22luo",
	"mainTitle": "Benefits_mainTitle__2IzR3",
	"list": "Benefits_list__3Pchs",
	"listItem": "Benefits_listItem__2HY8R",
	"head": "Benefits_head__3TcTk",
	"text": "Benefits_text__3VTyO",
	"img": "Benefits_img__150Gr",
	"leftWrapper": "Benefits_leftWrapper__1_q6p",
	"ul": "Benefits_ul__3qM4u"
};
