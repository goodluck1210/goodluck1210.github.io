...
module.exports = __webpack_require__("4k+F");
...
module.exports = JSON.parse("{\"title\":\".Net benefits in software development \",\"list\":[\"Full interoperability with existing code\",\"Complete and absolute interlanguage interaction\",\"A base class library that hides the complexities of using an API call directly and offers a consistent object model for all programming languages ​​that support .NET\",\"A common runtime environment for any .NET applications, regardless of the languages ​​in which they are created. One of the important points is that all languages ​​use the same set of built-in data types\",\"Truly simplifying the application deployment process. In .NET, there is no need to register double types in the system registry. Moreover, .NET allows different versions of the same dll to coexist peacefully on the same software\"]}");
...
// EXTERNAL MODULE: ./components/Technologies/Net/Goals/Goals.module.scss
var Goals_module = __webpack_require__("5ig/");
var Goals_module_default = /*#__PURE__*/__webpack_require__.n(Goals_module);

// EXTERNAL MODULE: external "react/jsx-runtime"
var jsx_runtime_ = __webpack_require__("F5FC");

// CONCATENATED MODULE: ./components/Technologies/Net/Goals/Goals.js
...
const Goals = ({
  ...
  const images = ['/images/technologies/net/goals/img1.png', '/images/technologies/net/goals/img2.png'];
  return /*#__PURE__*/Object(jsx_runtime_["jsxs"])("div", {
    className: Goals_module_default.a.wrapper,
    children: [width >= 768 && /*#__PURE__*/Object(jsx_runtime_["jsx"])("div", {
      className: Goals_module_default.a.leftWrapper,
      children: images.map((src, index) => /*#__PURE__*/Object(jsx_runtime_["jsx"])("div", {
        className: Goals_module_default.a.img,
      ...
      className: Goals_module_default.a.list,
      children: [/*#__PURE__*/Object(jsx_runtime_["jsx"])("h2", {
        className: Goals_module_default.a.mainTitle,
        children: title
        ...
        children: list.map(({
          ...
          children: [/*#__PURE__*/Object(jsx_runtime_["jsxs"])("li", {
            className: Goals_module_default.a.listItem,
            children: [/*#__PURE__*/Object(jsx_runtime_["jsxs"])("div", {
              className: Goals_module_default.a.head,
              ...
              className: Goals_module_default.a.text,
...
/* harmony default export */ var Goals_Goals = (Goals);
// EXTERNAL MODULE: ./components/Technologies/Net/Benefits/Benefits.module.scss
var Benefits_module = __webpack_require__("6s/c");
var Benefits_module_default = /*#__PURE__*/__webpack_require__.n(Benefits_module);

// CONCATENATED MODULE: ./components/Technologies/Net/Benefits/Benefits.js
...
// EXTERNAL MODULE: ./assets/data/net/goals.json
var net_goals = __webpack_require__("CZvF");

// EXTERNAL MODULE: ./assets/data/net/benefits.json
var net_benefits = __webpack_require__("2AcM");

// EXTERNAL MODULE: ./assets/data/net/reviews.json
var reviews = __webpack_require__("Rak2");

// EXTERNAL MODULE: ./assets/data/net/faq.json
var faq = __webpack_require__("dxbY");

// EXTERNAL MODULE: ./components/Technologies/Net/index.module.scss
var index_module = __webpack_require__("XIGm");
var index_module_default = /*#__PURE__*/__webpack_require__.n(index_module);

// CONCATENATED MODULE: ./pages/net/index.js
...
function Index({
  ...
  const headerImages = {
    mb: '/images/technologies/net/header/bgMob.jpg',
    tabl: '/images/technologies/net/header/bgTabl.jpg',
    desk: '/images/technologies/net/header/bgDesk.jpg'
  };
  const caseImages = {
    mb: '/images/technologies/net/case/imgMob.png',
    tabl: '/images/technologies/net/case/imgTabl.png',
    desk: '/images/technologies/net/case/imgDesk.png'
  };
  const caseBg = {
  ...
  return /*#__PURE__*/Object(jsx_runtime_["jsx"])(jsx_runtime_["Fragment"], {
    children: /*#__PURE__*/Object(jsx_runtime_["jsxs"])(Scroll["a" /* default */], {
      titles: ['.NET Consulting by WTT Solutions', 'The .NET Framework was designed with the following goals', '.Net benefits in software development ', 'WE COVER A WIDE MARKETING TECHNOLOGY DEVELOPMENT STACK', 'Pitch 59', 'HERE’S HOW YOU CAN GET IN TOUCH', 'Questions you may have'],
      children: [/*#__PURE__*/Object(jsx_runtime_["jsxs"])(head_default.a, {
        children: [/*#__PURE__*/Object(jsx_runtime_["jsx"])("title", {
          children: metadata["a" /* meta */].netTitle
        }), /*#__PURE__*/Object(jsx_runtime_["jsx"])("meta", {
          name: "description",
          content: metadata["a" /* meta */].netDescription
        })]
        ...
        children: /*#__PURE__*/Object(jsx_runtime_["jsx"])(Goals_Goals, {
          data: goals,
          width: width
        })
      }), /*#__PURE__*/Object(jsx_runtime_["jsx"])(ScrollSection["a" /* default */], {
...
async function getServerSideProps() {
  return {
    props: {
      goals: net_goals,
      benefits: net_benefits,
      reviewsData: reviews,
      faqData: faq
    }
  };
}
/* harmony default export */ var net = __webpack_exports__["default"] = (Index);
...
// Exports
module.exports = {
	"wrapper": "Goals_wrapper__1tAJD",
	"mainTitle": "Goals_mainTitle__2xNYJ",
	"list": "Goals_list__6nWLS",
	"listItem": "Goals_listItem__3Is9Y",
	"head": "Goals_head__3E64K",
	"text": "Goals_text___EWCJ",
	"img": "Goals_img__2K1Gz",
	"leftWrapper": "Goals_leftWrapper__2wMtE"
};
...
// Exports
module.exports = {
	"wrapper": "Benefits_wrapper__161OO",
	"mainTitle": "Benefits_mainTitle__3L_3z",
	"list": "Benefits_list__1VpSX",
	"listItem": "Benefits_listItem__8hd8m"
};
...
module.exports = JSON.parse("{\"title\":\"The .NET Framework was designed with the following goals\",\"list\":[{\"title\":\"object-oriented programming environment\",\"description\":\"Provide a consistent object-oriented programming environment for local storage and execution of object code, for local execution of code distributed over the Internet or for remote execution.\"},{\"title\":\"Providing a coded runtime where:\",\"description\":\"<ul> <li>minimized the likelihood of conflicts in the process of software deployment and version control;</li> <li>safe execution of code is guaranteed, including code generated by an unknown or incompletely trusted third-party vendor;</li> <li>eliminates performance issues with scripting runtimes or interpreted code;</li> </ul>\",\"img\":\"/images/technologies/net/goals/img1.png\"},{\"title\":\"design guidelines\",\"description\":\"Provides consistent design guidelines for different types of applications, such as Windows applications and web applications;\"},{\"title\":\"industry-standard interoperability\",\"description\":\"Provides industry-standard interoperability that ensures that .NET Framework code is integrated with any other code\",\"img\":\"/images/technologies/net/goals/img2.png\"}]}");
...
// Exports
module.exports = {
	"image": "Net_image__2fb7v",
	"caseWrapper": "Net_caseWrapper__3YBmn",
	"headerWrapper": "Net_headerWrapper__3SDmd"
};
...
module.exports = JSON.parse("[{\"question\":\"How many projects does your .NET dedicated team have released? \",\"answer\":\"Our .NET development team has released projects in different industries: Martech, Edtech, HRTech, Healthcare, Financial Services. You can read more about projects on the page “ Our work”. If you are interested in finished projects from a specific industry - leave a request and we will share our experience useful for your project\"},{\"question\":\"Where is your .NET development company located?\",\"answer\":\"We are located in Ukraine, Kyiv. You can get any advice on your project, implementation tools, and .NET development services online by filling out the feedback form.\"},{\"question\":\"Can I hire a dedicated .NET software development team for my project?\",\"answer\":\"First of all, you will have a .NET consultation with our project manager to get to know the end-user, clarify project vision, goals & scope, and identify risks. Our solutions are made to make your business work better. After discussion, our angular development team proceeds to the execution of the project.\"}]");
