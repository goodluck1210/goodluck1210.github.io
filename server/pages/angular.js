...
module.exports = __webpack_require__("jamn");
...
module.exports = JSON.parse("[{\"question\":\"How many projects does your Angular dedicated team have released? Can you name real product names?\",\"answer\":\"Our Angular development team has released more than 15 projects in different industries: Martech, Edtech, HRTech, Healthcare, Financial Services. Some examples of our development team's Angular use are projects Pitch 59, PLH, etc. You can read more about them on the page “ Our work”\"},{\"question\":\"Can you provide accurate references to where your Angular development company was involved?\",\"answer\":\"You can see the benefits of Angular development in the Pitch59 project <a href=https://pitch59.com/welcome target=_blank >(https://pitch59.com/welcome)</a>. If you are interested in finished projects from a specific industry - leave a request and we will share our experience useful for your project\"},{\"question\":\"Can I hire a dedicated Angular software development team for my project?\",\"answer\":\"First of all, you will have an Angular  consultation with our project manager to get to know the end-user, clarify project vision, goals & scope, and identify risks. Our solutions are made to make your business work better. After discussion, our angular development team proceeds to the execution of the project.\"},{\"question\":\"Where is your Angular development company located?\",\"answer\":\"We are located in Ukraine, Kyiv. You can get any advice on your project, implementation tools, and angular development services online by filling out the feedback form.\"}]");
...
module.exports = JSON.parse("{\"title\":\"Benefits of Angular in software development\",\"list\":[{\"title\":\"Component architecture\",\"description\":\"After dropping out of the MVW (Model-View-Anything) architecture, Angular and later adopted a strictly component architecture that facilitates reuse. Components can be used over and over again in an application. It also improves the readability of the code and makes maintenance easier\"},{\"title\":\"Server Performance\",\"description\":\"Angular supports caching out of the box and many features to keep your server performing well\",\"img\":\"/images/technologies/angular/benefits/img1.png\"},{\"title\":\"MVC\",\"description\":\"Model View Controller in angular sets up key functionality like scopes and data binding. It also provides isolation of the user interface and application logic from each other\"},{\"title\":\"Two-way data binding\",\"description\":\"One of the key features of Angular is two-way data binding, which forms the relationship between the model layer and the presentation layer in such a way that each reflects a change in the other. However, other competing platforms have adopted one-way data binding for simplicity\",\"img\":\"/images/technologies/angular/benefits/img2.png\"},{\"title\":\"Deal for the creation of enterprise-scale web applications\"},{\"title\":\"Third-Party Integrations \",\"description\":\"Angular offers a rich collection of third party integrations to further enhance its web application\",\"img\":\"/images/technologies/angular/benefits/img3.png\"}]}");
...
// Exports
module.exports = {
	"wrapper": "Benefits_wrapper__3eHtY",
	"mainTitle": "Benefits_mainTitle__1XixQ",
	"list": "Benefits_list__cZAOo",
	"listItem": "Benefits_listItem__1GRsw",
	"head": "Benefits_head__23HEJ",
	"text": "Benefits_text__3hMFQ",
	"img": "Benefits_img__Lnpfl",
	"leftWrapper": "Benefits_leftWrapper__RWbbX"
};
...
// EXTERNAL MODULE: ./components/Technologies/Angular/Benefits/Benefits.module.scss
var Benefits_module = __webpack_require__("aJoK");
var Benefits_module_default = /*#__PURE__*/__webpack_require__.n(Benefits_module);

// EXTERNAL MODULE: external "react/jsx-runtime"
var jsx_runtime_ = __webpack_require__("F5FC");

// CONCATENATED MODULE: ./components/Technologies/Angular/Benefits/Benefits.js
...
const Goals = ({
  ...
  const images = ['/images/technologies/angular/benefits/img1.png', '/images/technologies/angular/benefits/img2.png', '/images/technologies/angular/benefits/img3.png'];
  return /*#__PURE__*/Object(jsx_runtime_["jsxs"])("div", {
...
/* harmony default export */ var Benefits = (Goals);
...
// EXTERNAL MODULE: ./assets/data/angular/benefits.json
var angular_benefits = __webpack_require__("XzoH");

// EXTERNAL MODULE: ./assets/data/angular/reviews.json
var reviews = __webpack_require__("kA9R");

// EXTERNAL MODULE: ./assets/data/angular/faq.json
var faq = __webpack_require__("8iEe");

// EXTERNAL MODULE: ./components/Technologies/Angular/index.module.scss
var index_module = __webpack_require__("rmBv");
var index_module_default = /*#__PURE__*/__webpack_require__.n(index_module);

// CONCATENATED MODULE: ./pages/angular/index.js
...
function Index({
  ...
  const headerImages = {
    mb: '/images/technologies/angular/header/bgMob.png',
    tabl: '/images/technologies/angular/header/bgTabl.jpg',
    desk: '/images/technologies/angular/header/bgDesk.jpg'
  };
  return /*#__PURE__*/Object(jsx_runtime_["jsx"])(jsx_runtime_["Fragment"], {
    children: /*#__PURE__*/Object(jsx_runtime_["jsxs"])(Scroll["a" /* default */], {
      titles: ['Angular Consulting by WTT Solutions', 'Benefits of Angular in software development', 'WE COVER A WIDE MARKETING TECHNOLOGY DEVELOPMENT STACK', 'PLH-Idems', 'HERE’S HOW YOU CAN GET IN TOUCH', 'Questions you may have'],
      children: [/*#__PURE__*/Object(jsx_runtime_["jsxs"])(head_default.a, {
        children: [/*#__PURE__*/Object(jsx_runtime_["jsx"])("title", {
          children: metadata["a" /* meta */].angularTitle
        }), /*#__PURE__*/Object(jsx_runtime_["jsx"])("meta", {
          name: "description",
          content: metadata["a" /* meta */].angularDescription
        })]
        ...
        children: /*#__PURE__*/Object(jsx_runtime_["jsx"])(CasesPriview["a" /* default */], {
          caseId: 'plh',
          greenTitle: en["a" /* en */].plhGreenTitle,
          customTitle: 'PLH-Idems',
          subtitle0: 'For Parents and Teens',
          wrapperClass: index_module_default.a.caseWrapper,
          imgClass: index_module_default.a.image,
          filtersClass: index_module_default.a.filters
        })
      }), /*#__PURE__*/Object(jsx_runtime_["jsx"])(ScrollSection["a" /* default */], {
...
async function getServerSideProps() {
  return {
    props: {
      benefits: angular_benefits,
      reviewsData: reviews,
      faqData: faq
    }
  };
}
/* harmony default export */ var angular = __webpack_exports__["default"] = (Index);
...
// Exports
module.exports = {
	"image": "Angular_image__1omi7",
	"headerWrapper": "Angular_headerWrapper__1kaOh",
	"caseWrapper": "Angular_caseWrapper__1HHOw",
	"filters": "Angular_filters__2aG-5"
};
